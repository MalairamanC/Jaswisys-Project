...
const services = [
  ...
  },
  {
    title: "Consulting",
    description:
      "We delivers expert consulting in recruitment and HR, while optimizing IT, finance, and BPO operations, providing tailored solutions that streamline workflows, boost efficiency, reduce costs, and drive sustainable business growth.",
    fullInfo:
