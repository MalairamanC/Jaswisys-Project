...
const services = [
  ...
  },
  {
    title: "Consulting",
    description:
      "We deliver expert consulting in recruitment and HR processes, alongside optimizing Information Technology, finance, and BPO operations, enabling organizations to improve efficiency, reduce costs, and accelerate business growth.",
    fullInfo:
